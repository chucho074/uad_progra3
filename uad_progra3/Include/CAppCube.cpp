...
/* */
CAppCube::CAppCube() :
	CAppCube(CGameWindow::DEFAULT_WINDOW_WIDTH, CGameWindow::DEFAULT_WINDOW_HEIGHT)
{
}

/* */
CAppCube::CAppCube(int window_width, int window_height) :
...
/* */
void CAppCube::update(double deltaTime)
{
...
/* */
void CAppCube::onMouseMove(float deltaX, float deltaY)
{
...
/* */
void CAppCube::executeMenuAction()
{
	if (getMenu() != NULL)
	{
