...
#ifndef CAPPTRIANGLE_H
#define CAPPTRIANGLE_H
...
// --------------------------------------------------------------------------------------------------------------------------------------
class CAppTriangle : public CApp
{
private:
	...
	unsigned int m_triangleVertexArrayObject;
	unsigned int m_triangleTextureID;
	int m_numFaces;
...
public:
	...
	CAppTriangle();
	CAppTriangle(int window_width, int window_height);
	~CAppTriangle();
